...
export default class Gradient {
  ...
  waitForCssVars() {
    if (
      ...
      -1 !==
        this.computedCanvasStyle
          .getPropertyValue("--gradient-color-light-1")
          .indexOf("#")
    )
  ...
  initGradientColors() {
    this.sectionColors = [
      "--gradient-color-light-1",
      "--gradient-color-light-2",
      "--gradient-color-light-3",
      "--gradient-color-light-4",
    ]
      .map((cssPropertyName) => {
